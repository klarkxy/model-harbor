...
export class TraceService {
  ...
  async getTraceDetail(requestTraceId: string): Promise<TraceDetail> {
    ...
    const events: TraceEventItem[] = rawEvents.map((e) => ({
      ...
      providerAccountId: e.providerAccountId ?? null,
    ...
    const summary: TraceSummary = {
      ...
      clientId: usageRecord.clientId,
      clientKeyId: usageRecord.clientKeyId,
      requestedTargetName: usageRecord.requestedTargetName,
      providerAccountId: usageRecord.providerAccountId,
      endpointId: usageRecord.endpointId ?? null,
