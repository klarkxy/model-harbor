...
const menuOptions = computed<MenuOption[]>(() => [
  {
    type: 'group',
    label: t('layout.menuGroup.runtime'),
    key: 'group-runtime',
    children: [{ key: 'overview', label: t('layout.menu.overview') }],
  },
  {
    type: 'group',
    label: t('layout.menuGroup.config'),
    key: 'group-config',
    children: [
      { key: 'provider-accounts', label: t('layout.menu.providerAccounts') },
      { key: 'models', label: t('layout.menu.models') },
      { key: 'clients', label: t('layout.menu.clients') },
    ],
  },
  {
    type: 'group',
    label: t('layout.menuGroup.observability'),
    key: 'group-observability',
    children: [
  ...
  {
    type: 'group',
    label: t('layout.menuGroup.cost'),
    key: 'group-cost',
    children: [{ key: 'costs', label: t('layout.menu.costs') }],
  },
  {
    type: 'group',
    label: t('layout.menuGroup.ops'),
    key: 'group-ops',
    children: [
