...
const messages: Messages = {
  ...
  modelReference: {
    ...
    resultCount: '{count} 条',
    attribution: {
      title: '数据来源：ReLE 中文大模型评测榜单',
      modalTitle: '关于本榜单数据来源',
      body: '本页所有分数、排名与输出价格均来自非线智能维护的开源仓库 chinese-llm-benchmark（ReLE 评测）。ModelHarbor 仅做引用展示，不打包或转售其原始数据。',
      cite: '请按仓库要求注明引用来源与具体 tag（建议在 {leaderboard} 顶部查看当前快照的 tag）。完整引用格式见 {repo} 的 README。',
      acknowledge: '我已知晓',
    },
    columns: {
      model: '模型',
